...
namespace FitnessProject.Web.Mvc.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(FitnessAppContext.Create);
            app.CreatePerOwinContext<AppUserManager>(Compuskills.Projects.TotalTimesheetPro.Mvc.Identity.IdentityExtensions.CreateUserManager);
